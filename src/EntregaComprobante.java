...
public class EntregaComprobante {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ingresar Id Cliente: ");
        ...
        numeroFactura = "F001-" + String.format("%04d", IDcliente);

        // Generar el número de Boleta
        numeroBoleta = "B001-" + String.format("%04d", IDcliente);
